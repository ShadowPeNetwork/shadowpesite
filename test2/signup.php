 ...
 ?>
    ...
    <main>
        ...
        <form class="form-signup" action="includes/signup.inc.php" method="post">
            <input type="text" name="uid" class="signup-box" placeholder="Username">
            <input type="text" name="mail" class="signup-box" placeholder="E-Mail">
            <input type="password" name="pwd" class="signup-box" placeholder="Password">
            <input type="password" name="pwd-repeat" class="signup-box" placeholder="Repeat Password">
